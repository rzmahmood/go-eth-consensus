...
// Hash: 3903fea1e74ae01a690c03cf666a45bb589836894b777684b898bc5a87d44854
// Version: 0.1.4
package consensus
...
// MarshalSSZ ssz marshals the BeaconBlockWithStateDeneb object
func (b *BeaconBlockWithStateDeneb) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(b)
}

// MarshalSSZTo ssz marshals the BeaconBlockWithStateDeneb object to a target array
func (b *BeaconBlockWithStateDeneb) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(56)
	...
	// Offset (3) 'BeaconState'
	dst = ssz.WriteOffset(dst, offset)
	if b.BeaconState == nil {
		b.BeaconState = new(BeaconStateDeneb)
	}
	offset += b.BeaconState.SizeSSZ()

	// Offset (4) 'Body'
	dst = ssz.WriteOffset(dst, offset)

	// Field (3) 'BeaconState'
	if dst, err = b.BeaconState.MarshalSSZTo(dst); err != nil {
		return
	}
...
// UnmarshalSSZ ssz unmarshals the BeaconBlockWithStateDeneb object
func (b *BeaconBlockWithStateDeneb) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 56 {
		return ssz.ErrSize
	...
	// Field (3) 'BeaconState'
	{
		...
		if err = b.BeaconState.UnmarshalSSZ(buf); err != nil {
			return err
		}
	}
...
// SizeSSZ returns the ssz encoded size in bytes for the BeaconBlockWithStateDeneb object
func (b *BeaconBlockWithStateDeneb) SizeSSZ() (size int) {
	size = 56
...
// HashTreeRoot ssz hashes the BeaconBlockWithStateDeneb object
func (b *BeaconBlockWithStateDeneb) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(b)
}

// HashTreeRootWith ssz hashes the BeaconBlockWithStateDeneb object with a hasher
func (b *BeaconBlockWithStateDeneb) HashTreeRootWith(hh ssz.HashWalker) (err error) {
	indx := hh.Index()
	...
	// Field (3) 'BeaconState'
	if err = b.BeaconState.HashTreeRootWith(hh); err != nil {
		return
	}
...
// GetTree ssz hashes the BeaconBlockWithStateDeneb object
func (b *BeaconBlockWithStateDeneb) GetTree() (*ssz.Node, error) {
	return ssz.ProofTree(b)
}
